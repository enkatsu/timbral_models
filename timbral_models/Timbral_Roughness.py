...
def timbral_roughness_audio_samples(audio_samples, fs, dev_output=False, clip_output=False, peak_picking_threshold=0.01):
    """
     This function is an implementation of the Vassilakis [2007] model of roughness.
     The peak picking algorithm implemented is based on the MIR toolbox's implementation.
     ...
     Required parameter
      :param audio_samples:         list, Audio samples to be analysed.
